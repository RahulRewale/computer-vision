...
class robot:
    ...
    def sense(self):
        ...
        for ind in range(len(self.landmarks)):
            ...
            # skip the landmark if it is beyond the measurement range
            # if measurement range is -1, ignore the distance check; assume all landmarks are visible irrespective of their distances
            # referred https://knowledge.udacity.com/questions/366117 as suggested by reviewer
